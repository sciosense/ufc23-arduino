/*
    ...
    This example shows the measurements of many different parameters that the UFC23 can perform.

    It starts by measuring the high speed oscillator's frequency, the supply voltage, and performing a check of the spool connection.
    In each execution of the loop it reports the Time-of-Flight results, together with the amplitude of three different pulses and two pulse widths.
