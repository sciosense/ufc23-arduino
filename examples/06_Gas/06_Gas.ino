/*
    ...
    This example shows how to use the UFC23 to measure a gas flow.
    For this, a much higher gain must be used on the PGA along with the differential mode of the sensor.
    Please remember to check the connection of the US_VCMN and US_VCMP pins to be in differential mode.
    The configuration was chosen for a sensor made with two Jiakang Electronics PSC500K018060H2AD2-B1 transducers in air.
*/
...
void setup()
{
    ...
    Serial.println("Starting UFC23 06_Gas demo on Arduino...");
